export function fetch_dow_song(music_list: MusicList): Promise<boolean> {
...
export function fetch_dow_all_songs(artist_url: string, artist: string): Promise<any> {
...
/**
 * Fetch class for performing HTTP requests.
 */
export class Fetch {
    constructor() {
      // 构造函数逻辑
