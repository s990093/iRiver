...
SECRET_KEY = 'django-insecure-i*vm+k(e2^-^wjjv5f@)&m+!en&$_s@*20ac1hm_&#1!%%q4sd'
...
SOCIAL_AUTH_GOOGLE_OAUTH2_REDIRECT_URI = 'https://127.0.0.1:8000/user/auth/complete/google-oauth2/'
